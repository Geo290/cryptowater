...
import { idlFactory } from './cryptowater_backend.did.js';
export { idlFactory } from './cryptowater_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CRYPTOWATER_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cryptowater_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cryptowater_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cryptowater_backend.did.js")._SERVICE>}
 */
export const cryptowater_backend = createActor(canisterId);
