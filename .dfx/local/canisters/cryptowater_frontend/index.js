...
import { idlFactory } from './cryptowater_frontend.did.js';
export { idlFactory } from './cryptowater_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CRYPTOWATER_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cryptowater_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cryptowater_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cryptowater_frontend.did.js")._SERVICE>}
 */
export const cryptowater_frontend = createActor(canisterId);
